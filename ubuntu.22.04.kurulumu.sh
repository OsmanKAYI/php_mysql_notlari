...
sudo apt install git npm guake guake-indicator pv meld vim ncdu axel xclip net-tools caffeine vlc chromium-browser magic-wormhole gnome-sushi curl gnome-shell-extension-manager software-properties-common apt-transport-https wget curl -y
